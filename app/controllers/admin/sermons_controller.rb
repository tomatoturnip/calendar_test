class Admin::SermonsController < ApplicationController
  before_action :authenticate_user!, :set_sermon, only: [:edit, :update, :destroy]
  ...
  def update
    if @sermon.update(sermon_params)
      redirect_to admin_sermons_path, notice: "Sermon was successfully updated."
    else
      render :edit
    end
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_sermons_path }
      format.json { head :ok }
